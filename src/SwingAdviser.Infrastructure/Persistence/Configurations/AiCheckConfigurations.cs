...
{
 public void Configure(EntityTypeBuilder<AiCheckAttempt> b) { b.ToTable("ai_check_attempts"); b.HasKey(e=>e.AttemptId); b.HasIndex(e=>e.Status); b.Property(e=>e.RequestedAtUtc).HasConversion(UtcDateTimeTextConverter.Instance).HasColumnType("TEXT"); b.Property(e=>e.StartedAtUtc).HasConversion(UtcDateTimeTextConverter.Instance).HasColumnType("TEXT"); b.Property(e=>e.CompletedAtUtc).HasConversion(UtcDateTimeTextConverter.Instance).HasColumnType("TEXT"); b.Property(e=>e.EvaluationBarDate).HasConversion(JstDateTextConverter.Instance).HasColumnType("TEXT"); b.Property(e=>e.IsStale).HasColumnType("INTEGER"); b.HasOne(e=>e.CandidateResult).WithMany().HasForeignKey(e=>e.CandidateResultId).OnDelete(DeleteBehavior.Restrict); b.HasOne(e=>e.TriggeringDailyUpdateRun).WithMany().HasForeignKey(e=>e.TriggeringDailyUpdateRunId).OnDelete(DeleteBehavior.Restrict); b.HasOne(e=>e.TechnicalInputManifest).WithMany().HasForeignKey(e=>e.TechnicalInputManifestId).OnDelete(DeleteBehavior.Restrict); }
}
